      ...
      <div className="sm:py-18 container mx-auto px-3 py-10">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-12 grid grid-cols-1 gap-8 xl:col-span-2 xl:mt-0">
            <div className="grid grid-cols-2 gap-8 underline-offset-4 md:grid-cols-4">
              <div className="col-span-2">
                <h4 className="font-extrabold">Browse</h4>
                <ul className="mt-2 columns-2 space-y-2">
              ...
              <div>
                <h4 className="font-extrabold">Account</h4>
